...
public abstract class BaseAction implements GameAction {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("Action: ").append(key).append(", ").append("Interval: ")
				.append(baseInterval).append(" | " + variationPercentage + "% variation");
		...
		int timesUsed = DefaultScript.ACTIONS_COUNTER.get(key) != null ? DefaultScript.ACTIONS_COUNTER.get(key) : 0;

		sb.append(", Total times used: " + timesUsed);
