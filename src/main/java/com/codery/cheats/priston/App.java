...
//        //amount of time to use a potion directly at UsePot class.
    ...
    private final static Integer[] DEFAULT_STOP_CMD = new Integer[]{162/*ctrl*/, 88/*x*/};
    private final static Integer[] DEFAULT_START_CMD_0 = new Integer[]{162/*ctrl*/, 48};
    private final static Integer[] DEFAULT_START_CMD_1 = new Integer[]{162/*ctrl*/, 49};
    private final static Integer[] DEFAULT_START_CMD_2 = new Integer[]{162/*ctrl*/, 50};
    private final static Integer[] DEFAULT_START_CMD_3 = new Integer[]{162/*ctrl*/, 51};
    private final static Integer[] DEFAULT_START_CMD_4 = new Integer[]{162/*ctrl*/, 52};
    private final static Integer[] DEFAULT_START_CMD_5 = new Integer[]{162/*ctrl*/, 53};
    private final static Integer[] DEFAULT_START_CMD_6 = new Integer[]{162/*ctrl*/, 54};
    private final static Integer[] DEFAULT_START_CMD_7 = new Integer[]{162/*ctrl*/, 55};
    private final static Integer[] DEFAULT_START_CMD_8 = new Integer[]{162/*ctrl*/, 56};
    private final static Integer[] DEFAULT_START_CMD_9 = new Integer[]{162/*ctrl*/, 57};
